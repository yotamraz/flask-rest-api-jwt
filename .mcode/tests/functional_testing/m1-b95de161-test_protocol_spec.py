...
Generated at: 2026-03-02T17:12:38.495557+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/health/",
        "method": "GET",
        "description": "Health check returns 200 with healthy status when service and database are up",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/user/register",
        "method": "POST",
        "description": "Registering with an already-taken username returns 400 with 'User exists' message",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Logout with a valid access token returns 200 and blacklists the token",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
...
BASE_URL = os.path.expandvars("http://127.0.0.1:5000")
