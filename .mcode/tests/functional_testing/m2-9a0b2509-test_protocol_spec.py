...
Generated at: 2026-03-03T14:15:37.551827+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/store/",
        "method": "POST",
        "description": "Create a new store for the authenticated user and verify 201 response with store data",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/store/",
        "method": "POST",
        "description": "Attempt to create a store without an authentication token, expect 401",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/store/{id}",
        "method": "GET",
        "description": "Create a store then retrieve it by ID, verify it returns the correct store data",
        "setup": {
            "endpoint": "/store/",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/store/{id}",
        "method": "GET",
        "description": "Attempt to retrieve a non-existent store, expect 404",
        "setup": null,
        "request_data": {
            "path": {
                "id": 999999
    ...
    },
    {
        ...
        "endpoint": "/store/s",
        "method": "GET",
        "description": "Create a store then list all stores, verify the response is an array containing the created store",
        "setup": {
            "endpoint": "/store/",
            "method": "POST",
            "body": {
                "name": "Store For Listing"
            },
            "headers": {
                "Authorization": "Bearer $fresh_access_token"
            },
    ...
    },
    {
        ...
        "endpoint": "/store/s",
        "method": "GET",
        "description": "Attempt to list stores without authentication, expect 401",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/store/{id}",
        "method": "DELETE",
        "description": "Create a store then delete it, verify 200 with message Deleted",
        "setup": {
            "endpoint": "/store/",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/item/",
        "method": "POST",
        "description": "Create a store, then create an item in that store, verify 201 with item data",
        "setup": {
            "endpoint": "/store/",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/item/",
        "method": "POST",
        "description": "Attempt to create an item without authentication, expect 401",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/item/{id}",
        "method": "GET",
        "description": "Attempt to retrieve a non-existent item, expect 404",
        "setup": null,
        "request_data": {
            "path": {
                "id": 999999
    ...
    },
    {
        ...
        "endpoint": "/item/s",
        "method": "GET",
        "description": "Attempt to list items without authentication, expect 401",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
