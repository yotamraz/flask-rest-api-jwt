...
TEST_CASES = json.loads(r'''[
    {
        ...
        "endpoint": "/store/",
        "method": "POST",
        "description": "Create a new store with a valid name as an authenticated user",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/store/{id}",
        "method": "GET",
        "description": "Create a store, then retrieve it by ID, then delete it",
        "setup": {
            "endpoint": "/store/",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/store/s",
        "method": "GET",
        "description": "List all stores owned by the authenticated user, returns an array",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/store/{id}",
        "method": "DELETE",
        "description": "Create a store, then delete it by ID",
        "setup": {
            "endpoint": "/store/",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/item/s",
        "method": "GET",
        "description": "List all items across the authenticated user's stores, returns an array",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Create a store, then create a tag for that store, then clean up",
        "setup": {
            "endpoint": "/store/",
            "method": "POST",
            "body": {
                "name": "Store For Tag Creation"
            },
            "extract_id_from": "id"
        },
        "request_data": {
    ...
    },
    {
        ...
        "endpoint": "/tag/store/{store_id}",
        "method": "POST",
        "description": "Attempt to create a tag for a non-existent store, expect 404",
        "request_data": {
            "path": {
                "store_id": 999999
            },
    ...
    },
    {
        ...
        "setup": {
            ...
            "method": "POST",
            "body": {
                "name": "Store For Tag Missing Name"
            },
            "extract_id_from": "id"
        },
        "request_data": {
    ...
    },
    {
        ...
        "endpoint": "/tag/{id}",
        "method": "GET",
        "description": "Attempt to get a tag with a non-existent ID, expect 404",
        "request_data": {
            "path": {
                "id": 999999
            },
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Create a store, then list tags for that store (may be empty), then clean up",
        "setup": {
            "endpoint": "/store/",
            "method": "POST",
            "body": {
                "name": "Store For List Tags"
            },
            "extract_id_from": "id"
        },
        "request_data": {
    ...
    },
    {
        ...
        "endpoint": "/tag/store/{store_id}/s",
        "method": "GET",
        "description": "Attempt to list tags for a non-existent store, expect 404",
        "request_data": {
            "path": {
                "store_id": 999999
            },
    ...
    },
    {
        ...
        "endpoint": "/tag/{id}",
        "method": "DELETE",
        "description": "Attempt to delete a non-existent tag, expect 404",
        "request_data": {
            "path": {
                "id": 999999
            },
