...
Generated at: 2026-03-03T22:34:40.807107+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/health/",
        "method": "GET",
        "description": "Verify the health endpoint returns 200 with healthy status when service and database are reachable",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Register a new user with a unique username and password, expect 201 with user ID and username returned",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/user/register",
        "method": "POST",
        "description": "Attempt to register with an already-taken username, expect 400 with 'User exists' message",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/user/login",
        "method": "POST",
        "description": "Register a user then login with valid credentials, expect 200 with access_token and refresh_token",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/user/login",
        "method": "POST",
        "description": "Attempt login with incorrect password, expect 401 with 'Invalid credentials' message",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
                "username": "login_bad_pw_user",
                "password": "${TEST_PASSWORD}"
            },
            "extract_id_from": "id"
        },
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Refresh the access token using a valid refresh token in the Authorization header, expect 200 with new access_token",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "GET",
        "description": "Register a user, then retrieve own profile by ID with valid access token, expect 200 with user details",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "GET",
        "description": "Attempt to get user details without an access token, expect 401",
        "setup": null,
        "request_data": {
            "path": {
                "id": 1
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "DELETE",
        "description": "Register a user, then delete own account by ID with valid access token, expect 200 with 'Deleted' message",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
