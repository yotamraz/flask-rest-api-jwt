...
Generated at: 2026-03-03T12:11:07.262605+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/health/",
        "method": "GET",
        "description": "Verify health endpoint returns 200 with healthy status and database connectivity",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Register a new user with a unique username and password, expect 201 with user id and username",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/user/register",
        "method": "POST",
        "description": "Attempt to register a user with an already existing username, expect 400 with 'User exists' message",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/user/login",
        "method": "POST",
        "description": "Attempt login with non-existent username and wrong password, expect 401 with 'Invalid credentials' message",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
