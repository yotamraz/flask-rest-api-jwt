...
Generated at: 2026-03-05T12:24:14.428889+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/health/",
        "method": "GET",
        "description": "Verify health endpoint returns 200 with healthy status when service and database are operational",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/health/",
        "method": "GET",
        "description": "Verify health endpoint response contains both 'status' and 'database' fields with expected values",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
