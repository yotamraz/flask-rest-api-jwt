...
Generated at: 2026-02-16T12:02:51.383684+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/health/",
        "method": "GET",
        "description": "Verify that the health check endpoint returns 200 with healthy status when the API and database are operational",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/health/",
        "method": "GET",
        "description": "Verify the health check response contains both 'status' and 'database' fields with 'healthy' values",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "health_check_method_not_allowed_post",
        "category": "INVALID_INPUT",
        "endpoint": "/health/",
        "method": "POST",
        "description": "Verify that POST method is not allowed on the health check endpoint and returns 405",
        "request_data": {
            "path": {},
            "query": {},
            "body": {}
    ...
    {
        "name": "health_check_method_not_allowed_delete",
        "category": "INVALID_INPUT",
        "endpoint": "/health/",
        "method": "DELETE",
        "description": "Verify that DELETE method is not allowed on the health check endpoint and returns 405",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
