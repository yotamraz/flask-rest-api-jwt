...
Generated at: 2026-03-02T16:39:18.175878+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "method": "POST",
        "description": "Register a test user for authentication in subsequent tests",
        "skip_auth": true,
        "request_data": {
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/user/login",
        "method": "POST",
        "description": "Login with test user to obtain JWT access token for authenticated requests",
        "skip_auth": true,
        "request_data": {
            "body": {
                "username": "tagtest_user",
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Create a store, then create a tag in that store, and verify 201 response with tag data",
        "setup": {
            "endpoint": "/store/",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/tag/store/{store_id}",
        "method": "POST",
        "description": "Attempt to create a tag in a non-existent store and verify 404 response",
        "setup": null,
        "request_data": {
            "path": {
                "store_id": 99999
    ...
    },
    {
        ...
        "endpoint": "/tag/{id}",
        "method": "GET",
        "description": "Attempt to get a tag that does not exist and verify 404 response",
        "setup": null,
        "request_data": {
            "path": {
                "id": 99999
    ...
    {
        "name": "get_tag_id_zero_boundary",
        "category": "BOUNDARY",
        "endpoint": "/tag/{id}",
        "method": "GET",
        "description": "Attempt to get a tag with ID 0 (edge case) and verify 404 response",
        "setup": null,
        "request_data": {
            "path": {
                "id": 0
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Create a store then list its tags (empty list expected) and verify 200 response",
        "setup": {
            "endpoint": "/store/",
            "method": "POST",
            "body": {
                "name": "Store For Listing Tags"
            },
            "extract_id_from": "id"
        },
        "request_data": {
    ...
    },
    {
        ...
        "endpoint": "/tag/store/{store_id}/s",
        "method": "GET",
        "description": "Attempt to list tags for a non-existent store and verify 404 response",
        "setup": null,
        "request_data": {
            "path": {
                "store_id": 99999
    ...
    },
    {
        ...
        "endpoint": "/tag/{id}",
        "method": "DELETE",
        "description": "Attempt to delete a tag that does not exist and verify 404 response",
        "setup": null,
        "request_data": {
            "path": {
                "id": 99999
    ...
    {
        "name": "delete_tag_id_zero_boundary",
        "category": "BOUNDARY",
        "endpoint": "/tag/{id}",
        "method": "DELETE",
        "description": "Attempt to delete a tag with ID 0 (edge case) and verify 404 response",
        "setup": null,
        "request_data": {
            "path": {
                "id": 0
