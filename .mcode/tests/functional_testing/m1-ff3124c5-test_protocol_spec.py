...
Generated at: 2026-03-05T12:57:42.510364+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/health/",
        "method": "GET",
        "description": "Verify health endpoint returns 200 with healthy status when API and database are reachable",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Register a new user with a valid username and password, expect 201 with user object returned",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/user/register",
        "method": "POST",
        "description": "Attempt to register with an already existing username returns 400",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/user/login",
        "method": "POST",
        "description": "Login with valid credentials returns 200 with access_token and refresh_token",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/user/login",
        "method": "POST",
        "description": "Login with wrong password returns 401 with invalid credentials message",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "GET",
        "description": "Retrieve own profile by ID using the authenticated user's token",
        "request_data": {
            "path": {
                "id": "$stored.main_user_id"
            },
            "query": {},
            "body": null
        },
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "GET",
        "description": "Get user by ID without authentication returns 401",
        "request_data": {
            "path": {
                "id": 1
            },
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "GET",
        "description": "Get a non-existent user by ID returns 404",
        "request_data": {
            "path": {
                "id": 99999
            },
    ...
    },
    {
        ...
        "endpoint": "/user/refresh",
        "method": "POST",
        "description": "Refresh without providing a token returns 401",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "DELETE",
        "description": "Delete own account using the authenticated user's token",
        "request_data": {
            "path": {
                "id": "$stored.main_user_id"
            },
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "DELETE",
        "description": "Delete user without authentication returns 401",
        "request_data": {
            "path": {
                "id": 1
            },
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Logout with a valid access token revokes the token and returns 200",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/user/logout",
        "method": "POST",
        "description": "Logout without providing an access token returns 401",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
