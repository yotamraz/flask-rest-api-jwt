...
Generated at: 2026-02-16T14:31:06.832779+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/health/",
        "method": "GET",
        "description": "Verify health endpoint returns 200 with healthy status when application and database are running",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/health/",
        "method": "GET",
        "description": "Verify health endpoint response contains both 'status' and 'database' fields with 'healthy' values",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "health_check_no_trailing_slash",
        "category": "BOUNDARY",
        "endpoint": "/health",
        "method": "GET",
        "description": "Verify health endpoint handles request without trailing slash (should redirect or respond)",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
