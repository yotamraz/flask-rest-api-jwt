...
Generated at: 2026-02-24T23:57:37.474516+00:00
...
TEST_CASES = json.loads(r'''[
    ...
    },
    {
        ...
        "endpoint": "/user/login",
        "method": "POST",
        "description": "Register a user then login with the correct credentials to receive JWT tokens",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/user/login",
        "method": "POST",
        "description": "Register a user then attempt login with the wrong password",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/user/login",
        "method": "POST",
        "description": "Attempt login with a username that does not exist in the database",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Logout with a valid access token, revoking it",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    {
        "name": "logout_user_no_auth",
        "category": "MISSING_REQUIRED",
        "endpoint": "/user/logout",
        "method": "POST",
        "description": "Attempt logout without providing an Authorization header",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Refresh access token using a valid refresh token in Authorization header",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/user/refresh",
        "method": "POST",
        "description": "Attempt token refresh without providing an Authorization header",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "GET",
        "description": "Attempt to get a user without providing an Authorization header",
        "setup": null,
        "request_data": {
            "path": {
                "id": 1
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "DELETE",
        "description": "Attempt to delete a user with a non-existent ID",
        "setup": null,
        "request_data": {
            "path": {
                "id": 99999
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "DELETE",
        "description": "Attempt to delete a user without providing an Authorization header",
        "setup": null,
        "request_data": {
            "path": {
                "id": 1
    ...
    },
    {
        ...
        "endpoint": "/store/",
        "method": "POST",
        "description": "Attempt to create a store without providing an Authorization header",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/store/{id}",
        "method": "GET",
        "description": "Create a store then retrieve it by ID as the owner",
        "setup": {
            "endpoint": "/store/",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/store/{id}",
        "method": "GET",
        "description": "Attempt to get a store with a non-existent ID",
        "setup": null,
        "request_data": {
            "path": {
                "id": 99999
    ...
    },
    {
        ...
        "endpoint": "/store/s",
        "method": "GET",
        "description": "List all stores for the authenticated user (may return empty array)",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/store/s",
        "method": "GET",
        "description": "Attempt to list stores without providing an Authorization header",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/store/{id}",
        "method": "DELETE",
        "description": "Create a store then delete it as the owner",
        "setup": {
            "endpoint": "/store/",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/store/{id}",
        "method": "DELETE",
        "description": "Attempt to delete a store with a non-existent ID",
        "setup": null,
        "request_data": {
            "path": {
                "id": 99999
    ...
    },
    {
        ...
        "endpoint": "/health/",
        "method": "GET",
        "description": "Verify the health endpoint returns 200 with healthy status when service and database are up",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
