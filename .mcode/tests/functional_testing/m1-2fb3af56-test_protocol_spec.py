...
Generated at: 2026-03-03T14:06:31.451759+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "endpoint": "/user/login",
        "method": "POST",
        "description": "Attempt to login with a non-existent username and wrong password, expect 401",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    {
        "name": "get_user_missing_auth",
        "category": "AUTH",
        "endpoint": "/user/{id}",
        "method": "GET",
        "description": "Attempt to get a user without providing an authorization token, expect 401",
        "setup": null,
        "request_data": {
            "path": {
                "id": 1
    ...
    {
        "name": "delete_user_missing_auth",
        "category": "AUTH",
        "endpoint": "/user/{id}",
        "method": "DELETE",
        "description": "Attempt to delete a user without providing an authorization token, expect 401",
        "setup": null,
        "request_data": {
            "path": {
                "id": 1
    ...
    },
    {
        ...
        "endpoint": "/health/",
        "method": "GET",
        "description": "Check health endpoint returns 200 with healthy status when API and database are up",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
