...
Generated at: 2026-02-16T12:19:01.238619+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/health/",
        "method": "GET",
        "description": "Verify the health endpoint returns 200 with healthy status when the app and database are running",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Register a new user with valid username and password, expect 201 with user object returned (no password_hash)",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/user/register",
        "method": "POST",
        "description": "Attempt to register a user without providing a password field, expect 400 or 422",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/user/login",
        "method": "POST",
        "description": "Login with valid credentials and receive access_token and refresh_token",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Logout with a valid access token, expect 200 and token to be blacklisted",
        "request_data": {
            "path": {},
            "query": {},
            "body": null,
    ...
    },
    {
        ...
        "endpoint": "/user/logout",
        "method": "POST",
        "description": "Attempt logout without providing an Authorization header, expect 401",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Refresh access token using a valid refresh token in the Authorization header",
        "request_data": {
            "path": {},
            "query": {},
            "body": null,
    ...
    },
    {
        ...
        "endpoint": "/user/refresh",
        "method": "POST",
        "description": "Attempt token refresh without providing any token, expect 401",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "GET",
        "description": "Create a user, login to get a token, then retrieve the user by ID",
        "request_data": {
            "path": {
                "id": "$setup_id"
            },
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "DELETE",
        "description": "Create a user, login, then delete the user by ID \u2014 expect 200 confirmation",
        "request_data": {
            "path": {
                "id": "$setup_id"
            },
