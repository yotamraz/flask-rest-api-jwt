...
TEST_CASES = json.loads(r'''[
    {
        ...
        "method": "POST",
        "description": "Register a new user with valid username and password, expect 201 with user object returned",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/user/login",
        "method": "POST",
        "description": "Register a user then login with correct credentials, expect 200 with access and refresh tokens",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/user/login",
        "method": "POST",
        "description": "Register a user then attempt login with wrong password, expect 401",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "request_data": {
            ...
            "query": {},
            "body": {
                "username": "nonexistent_user_xyz_987",
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Use a valid refresh token to obtain a new access token, expect 200 with new access_token",
        "request_data": {
            "path": {},
            "query": {},
            "body": null,
    ...
    },
    {
        ...
        "endpoint": "/user/refresh",
        "method": "POST",
        "description": "Attempt to refresh without providing any token, expect 401",
        "skip_auth": true,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/user/refresh",
        "method": "POST",
        "description": "Attempt to refresh using an access token instead of a refresh token, expect 422",
        "request_data": {
            "path": {},
            "query": {},
            "body": null,
