...
Generated at: 2026-02-16T15:09:38.609703+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "method": "POST",
        "description": "Register a new user with valid username and password, expect 201 with user object returned (id and username, no password_hash)",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/user/register",
        "method": "POST",
        "description": "Attempt to register a user with a username that already exists, expect 400 with 'User exists' message",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/user/login",
        "method": "POST",
        "description": "Login with valid credentials after registering a user, expect 200 with access_token and refresh_token in response",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/user/login",
        "method": "POST",
        "description": "Login with incorrect password, expect 401 with 'Invalid credentials' message",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/user/login",
        "method": "POST",
        "description": "Login with a username that does not exist, expect 401 with 'Invalid credentials' message",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Logout with a valid access token, expect 200 with 'Logged out' message. The token should be blacklisted after this.",
        "request_data": {
            "path": {},
            "query": {},
            "body": null,
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Refresh access token using a valid refresh token in the Authorization header, expect 200 with new access_token",
        "request_data": {
            "path": {},
            "query": {},
            "body": null,
    ...
    },
    {
        ...
        "endpoint": "/user/refresh",
        "method": "POST",
        "description": "Attempt to refresh without providing a token, expect 401",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "GET",
        "description": "Register a user, login to get access token, then GET the user by ID. Expect 200 with user data (id and username).",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
                "username": "testuser_getid1",
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "DELETE",
        "description": "Register a user, login to get access token, then DELETE the user by ID. Expect 200 with 'Deleted' message.",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
