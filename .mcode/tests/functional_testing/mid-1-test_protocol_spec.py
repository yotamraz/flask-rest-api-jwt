...
Generated at: 2026-02-13T23:34:02.430889+00:00
...
TEST_CASES = json.loads(r'''[
    {
        ...
        "method": "POST",
        "description": "Register a new user with valid username and password, then clean up",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/user/register",
        "method": "POST",
        "description": "Attempt to register a user without providing a username, expect error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/user/login",
        "method": "POST",
        "description": "Register a user, then login with correct credentials, expect access and refresh tokens",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Login and then logout with a valid access token, expect success message",
        "request_data": {
            "path": {},
            "query": {},
            "body": null,
    ...
    {
        "name": "refresh_token_with_access_token",
        "category": "INVALID_INPUT",
        "endpoint": "/user/refresh",
        "method": "POST",
        "description": "Attempt to refresh using an access token instead of a refresh token, expect 422 or 401",
        "request_data": {
            "path": {},
            "query": {},
            "body": null,
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Register a user, login, then retrieve own user details by ID",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/user/{user_id}",
        "method": "GET",
        "description": "Attempt to get a user without providing an access token, expect 401",
        "request_data": {
            "path": {
                "user_id": 1
            },
    ...
    },
    {
        ...
        "endpoint": "/user/{user_id}",
        "method": "DELETE",
        "description": "Register a user, login, then delete own user account",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
                "username": "deluser_test",
