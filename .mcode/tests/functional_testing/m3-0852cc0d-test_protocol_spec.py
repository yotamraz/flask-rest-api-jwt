...
Generated at: 2026-03-03T14:15:39.090527+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Create a store, then list tags in that store. Expects 200 with an array response (initially empty).",
        "setup": {
            "endpoint": "/store/",
            "method": "POST",
            "body": {
