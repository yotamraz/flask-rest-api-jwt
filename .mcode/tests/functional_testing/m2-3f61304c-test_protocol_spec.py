...
Generated at: 2026-03-03T12:01:46.396796+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "endpoint": "/store/{id}",
        "method": "GET",
        "description": "Create a store then retrieve it by ID, verifying ownership check passes for the creator",
        "setup": {
            "endpoint": "/store/",
            "method": "POST",
            "headers": {
    ...
    },
    {
        ...
        "endpoint": "/store/s",
        "method": "GET",
        "description": "List all stores for the authenticated user, expecting a JSON array response",
        "request_data": {
            "headers": {
                "Authorization": "Bearer $fresh_access_token"
            },
    ...
    },
    {
        ...
        "endpoint": "/store/{id}",
        "method": "DELETE",
        "description": "Create a store then delete it, verifying the deletion message response",
        "setup": {
            "endpoint": "/store/",
            "method": "POST",
            "headers": {
    ...
    },
    {
        ...
        "endpoint": "/item/",
        "method": "POST",
        "description": "Create a store first, then create an item in it, verifying 201 response with item data",
        "setup": {
            "endpoint": "/store/",
            "method": "POST",
            "headers": {
    ...
    },
    {
        ...
        "endpoint": "/item/s",
        "method": "GET",
        "description": "List all items across the authenticated user's stores, expecting a JSON array",
        "request_data": {
            "headers": {
                "Authorization": "Bearer $fresh_access_token"
            },
    ...
    },
    {
        ...
        "endpoint": "/item/{id}",
        "method": "PUT",
        "description": "Attempt to update a non-existent item, expecting 404",
        "request_data": {
            "headers": {
                "Authorization": "Bearer $fresh_access_token"
            },
