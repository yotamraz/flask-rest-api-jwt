...
Generated at: 2026-03-04T00:04:10.401386+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/health/",
        "method": "GET",
        "description": "Verify health endpoint returns 200 with healthy status when service and DB are up",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Register a new user with valid username and password, expect 201 with user id and username returned",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
                "username": "register_happy_user",
    ...
    },
    {
        ...
        "endpoint": "/user/register",
        "method": "POST",
        "description": "Attempt to register with an already-existing username, expect 400 with 'User exists' message",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/user/register",
        "method": "POST",
        "description": "Attempt to register without providing a password field, expect 500 because the Flask app has an unhandled KeyError on missing password",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/user/login",
        "method": "POST",
        "description": "Login with valid credentials for auth_test_user (created by bootstrap). Sets up Bearer token session for subsequent authenticated tests.",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/user/login",
        "method": "POST",
        "description": "Attempt login with a non-existent username and wrong password, expect 401 Invalid credentials",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/user/login",
        "method": "POST",
        "description": "Register a user then attempt login with correct username but wrong password, expect 401",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "GET",
        "description": "Retrieve auth_test_user (ID=1) by ID using the Bearer token from the auth session. Expects 200 with id and username.",
        "request_data": {
            "path": {
                "id": 1
            },
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "GET",
        "description": "Attempt to get a user that does not exist (ID 99999) while authenticated, expect 404",
        "request_data": {
            "path": {
                "id": 99999
            },
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Refresh access token using the refresh token stored from login. Overrides Authorization header with refresh token.",
        "request_data": {
            "path": {},
            "query": {},
            "headers": {
                "Authorization": "Bearer $stored.auth_refresh_token"
            },
            "body": null
        },
        "expected_status": 200,
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "DELETE",
        "description": "Delete auth_test_user (ID=1) using the Bearer token from the auth session. Expects 200 with 'Deleted' message.",
        "request_data": {
            "path": {
                "id": 1
            },
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Logout with a valid access token from the auth session, expect 200 with 'Logged out' message. Token is revoked.",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/user/logout",
        "method": "POST",
        "description": "Attempt logout without providing a Bearer token, expect 401 unauthorized",
        "skip_auth": true,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "GET",
        "description": "Attempt to get a user without providing a Bearer token, expect 401",
        "skip_auth": true,
        "request_data": {
            "path": {
                "id": 1
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "DELETE",
        "description": "Attempt to delete a user without providing a Bearer token, expect 401",
        "skip_auth": true,
        "request_data": {
            "path": {
                "id": 1
