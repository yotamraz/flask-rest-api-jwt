...
Generated at: 2026-03-03T22:42:37.837663+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/store/",
        "method": "POST",
        "description": "Create a new store with valid name while authenticated",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/store/",
        "method": "POST",
        "description": "Attempt to create a store without authentication token",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/store/{id}",
        "method": "GET",
        "description": "Attempt to retrieve a store that does not exist",
        "request_data": {
            "path": {
                "id": 999999
            },
    ...
    },
    {
        ...
        "endpoint": "/store/{id}",
        "method": "GET",
        "description": "Attempt to get a store without authentication",
        "request_data": {
            "path": {
                "id": 1
            },
    ...
    },
    {
        ...
        "endpoint": "/store/s",
        "method": "GET",
        "description": "Create a store, then list all stores for the authenticated user",
        "setup": {
            "endpoint": "/store/",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/store/s",
        "method": "GET",
        "description": "Attempt to list stores without authentication",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/store/{id}",
        "method": "DELETE",
        "description": "Create a store, then delete it",
        "setup": {
            "endpoint": "/store/",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/store/{id}",
        "method": "DELETE",
        "description": "Attempt to delete a store that does not exist",
        "request_data": {
            "path": {
                "id": 999999
            },
    ...
    },
    {
        ...
        "endpoint": "/item/",
        "method": "POST",
        "description": "Create a store, then create an item in that store",
        "setup": {
            "endpoint": "/store/",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/item/",
        "method": "POST",
        "description": "Attempt to create an item without authentication",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/item/s",
        "method": "GET",
        "description": "Create a store and item, then list all items for the authenticated user",
        "setup": {
            "endpoint": "/store/",
            "method": "POST",
            "body": {
                "name": "Store For Item Listing"
            },
            "headers": {
                "Authorization": "Bearer $fresh_access_token"
            },
    ...
    },
    {
        ...
        "endpoint": "/item/s",
        "method": "GET",
        "description": "Attempt to list items without authentication",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/item/{id}",
        "method": "GET",
        "description": "Attempt to get an item without authentication",
        "request_data": {
            "path": {
                "id": 1
            },
    ...
    },
    {
        ...
        "endpoint": "/item/{id}",
        "method": "PUT",
        "description": "Attempt to update an item without authentication",
        "request_data": {
            "path": {
                "id": 1
            },
    ...
    },
    {
        ...
        "endpoint": "/item/{id}",
        "method": "DELETE",
        "description": "Create a store and item, then delete the item",
        "setup_chain": [
            {
                "endpoint": "/store/",
                "method": "POST",
    ...
    },
    {
        ...
        "endpoint": "/item/{id}",
        "method": "DELETE",
        "description": "Attempt to delete an item without authentication",
        "request_data": {
            "path": {
                "id": 1
            },
