...
Generated at: 2026-03-02T16:47:33.358232+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/store/",
        "method": "POST",
        "description": "Create a new store for the authenticated user and verify 201 with store data",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/store/",
        "method": "POST",
        "description": "Attempt to create a store without a JWT token, expect 401",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/store/{id}",
        "method": "GET",
        "description": "Create a store, then retrieve it by ID and verify the response contains store data",
        "setup": {
            "endpoint": "/store/",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/store/s",
        "method": "GET",
        "description": "List all stores for the authenticated user, expect 200 with array response",
        "request_data": {
            "path": {},
            "query": {},
            "body": null,
    ...
    {
        "name": "list_stores_no_auth",
        "category": "AUTH",
        "endpoint": "/store/s",
        "method": "GET",
        "description": "Attempt to list stores without JWT token, expect 401",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/store/{id}",
        "method": "DELETE",
        "description": "Create a store, then delete it and verify the response contains a Deleted message",
        "setup": {
            "endpoint": "/store/",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/store/{id}",
        "method": "DELETE",
        "description": "Attempt to delete a non-existent store, expect 404",
        "request_data": {
            "path": {
                "id": 999999
            },
    ...
    },
    {
        ...
        "endpoint": "/item/",
        "method": "POST",
        "description": "Create a store first, then create an item in that store, expect 201",
        "setup": {
            "endpoint": "/store/",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/item/",
        "method": "POST",
        "description": "Attempt to create an item without JWT token, expect 401",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/item/s",
        "method": "GET",
        "description": "List all items across the authenticated user's stores, expect 200 with array",
        "request_data": {
            "path": {},
            "query": {},
            "body": null,
    ...
    {
        "name": "list_items_no_auth",
        "category": "AUTH",
        "endpoint": "/item/s",
        "method": "GET",
        "description": "Attempt to list items without JWT token, expect 401",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/item/{id}",
        "method": "GET",
        "description": "Attempt to get an item without JWT token, expect 401",
        "request_data": {
            "path": {
                "id": 1
            },
    ...
    },
    {
        ...
        "endpoint": "/item/{id}",
        "method": "PUT",
        "description": "Attempt to update an item without JWT token, expect 401",
        "request_data": {
            "path": {
                "id": 1
            },
    ...
    },
    {
        ...
        "endpoint": "/item/{id}",
        "method": "DELETE",
        "description": "Attempt to delete an item without JWT token, expect 401",
        "request_data": {
            "path": {
                "id": 1
            },
