...
Generated at: 2026-02-14T02:19:10.900996+00:00
...
TEST_CASES = json.loads(r'''[
    {
        ...
        "endpoint": "/store/",
        "method": "POST",
        "description": "Create a new store with a valid name for the authenticated user, expect 201 with store details",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/store/",
        "method": "POST",
        "description": "Attempt to create a store without providing an access token, expect 401",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Create a store via setup, then retrieve it by ID to verify ownership access",
        "setup": {
            "endpoint": "/store/",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/store/{store_id}",
        "method": "GET",
        "description": "Attempt to get a store with a non-existent ID, expect 404",
        "setup": null,
        "request_data": {
            "path": {
                "store_id": 99999
    ...
    {
        "name": "get_store_no_auth",
        "category": "MISSING_REQUIRED",
        "endpoint": "/store/{store_id}",
        "method": "GET",
        "description": "Attempt to get a store without providing an access token, expect 401",
        "setup": null,
        "request_data": {
            "path": {
                "store_id": 1
    ...
    {
        "name": "get_all_stores_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/store/s",
        "method": "GET",
        "description": "List all stores for the authenticated user, expect an array response",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    {
        "name": "get_all_stores_no_auth",
        "category": "MISSING_REQUIRED",
        "endpoint": "/store/s",
        "method": "GET",
        "description": "Attempt to list stores without providing an access token, expect 401",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/store/{store_id}",
        "method": "DELETE",
        "description": "Create a store via setup, then delete it and verify success",
        "setup": {
            "endpoint": "/store/",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/store/{store_id}",
        "method": "DELETE",
        "description": "Attempt to delete a store with a non-existent ID, expect 404",
        "setup": null,
        "request_data": {
            "path": {
                "store_id": 99999
    ...
    },
    {
        ...
        "endpoint": "/item/",
        "method": "POST",
        "description": "Attempt to create an item in a non-existent store, expect 404",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    {
        "name": "create_item_no_auth",
        "category": "MISSING_REQUIRED",
        "endpoint": "/item/",
        "method": "POST",
        "description": "Attempt to create an item without providing an access token, expect 401",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/item/s",
        "method": "GET",
        "description": "List all items across the authenticated user's stores, expect an array response",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/item/s",
        "method": "GET",
        "description": "Attempt to list items without providing an access token, expect 401",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Attempt to get an item with a non-existent ID, expect 404",
        "setup": null,
        "request_data": {
            "path": {
                "item_id": 99999
    ...
    {
        "name": "get_item_no_auth",
        "category": "MISSING_REQUIRED",
        "endpoint": "/item/{item_id}",
        "method": "GET",
        "description": "Attempt to get an item without providing an access token, expect 401",
        "setup": null,
        "request_data": {
            "path": {
                "item_id": 1
    ...
    },
    {
        ...
        "endpoint": "/item/{item_id}",
        "method": "PUT",
        "description": "Attempt to update a non-existent item, expect 404",
        "setup": null,
        "request_data": {
            "path": {
                "item_id": 99999
    ...
    {
        "name": "update_item_no_auth",
        "category": "MISSING_REQUIRED",
        "endpoint": "/item/{item_id}",
        "method": "PUT",
        "description": "Attempt to update an item without providing an access token, expect 401",
        "setup": null,
        "request_data": {
            "path": {
                "item_id": 1
    ...
    },
    {
        ...
        "endpoint": "/item/{item_id}",
        "method": "DELETE",
        "description": "Attempt to delete a non-existent item, expect 404",
        "setup": null,
        "request_data": {
            "path": {
                "item_id": 99999
    ...
    {
        "name": "delete_item_no_auth",
        "category": "MISSING_REQUIRED",
        "endpoint": "/item/{item_id}",
        "method": "DELETE",
        "description": "Attempt to delete an item without providing an access token, expect 401",
        "setup": null,
        "request_data": {
            "path": {
                "item_id": 1
